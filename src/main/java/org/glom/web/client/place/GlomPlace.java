...
/**
 * A derived GWT Place with a Tokenizer that
 * can parse and build the URL's token parameters.
 * TODO: These are commonly re-implemented. Ask for them to be added to GWT? Are they in GWP?
 * 
 * @author Murray Cumming <murrayc@openismus.com>
 *
 */
public abstract class GlomPlace extends Place {
