...
public class DetailsPlaceTest extends TestCase {
	...
	public void testGetPlaceParameters()  {
		...
		DetailsPlace place = getDetailsPlaceFromToken("document=" + documentId + "&table=" + tableName + "&value=" + primaryKeyValue);
	...
	private void checkParameters(DetailsPlace place, final String documentID, final String tableName, final String primaryKeyValue) {
